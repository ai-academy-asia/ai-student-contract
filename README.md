...
- AI Engineer сертификатын QR → `/contract/cert/verify?t=<token>` баталгаажуулах
  хуудас (сайтын header/footer-той). Токен нь **DB-гүйгээр** HMAC-SHA256-аар
  шалгагдана; production-д `CERT_SIGNING_SECRET`-ийг заавал тохируулна.
